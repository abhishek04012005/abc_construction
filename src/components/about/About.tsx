      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h1 className={styles.title}>
            About <span className={styles.highlight}>ABC Constructions</span>
          </h1>
        ...
        <div className={styles.content}>
          <div className={styles.storySection}>
            <h2>Our Story</h2>
            <p>
              Founded in 2012, ABC Constructions has established itself as a leading name in the construction industry.
